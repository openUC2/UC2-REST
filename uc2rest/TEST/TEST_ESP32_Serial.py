...
if not position1[0]==1000:
    print("Failed getting motor position")
    ESP32.motor.get_position(timeout=1)[0]

print(position1)
ESP32.motor.set_motor_enable(enable=1, enableauto=False)# always on
ESP32.motor.move_x(steps=1000, speed=10000, is_blocking=True)
